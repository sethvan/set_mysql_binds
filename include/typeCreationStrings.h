        ...
        { { "char",
          ...
          { "longblob",
            { "std::make_unique<TypeCharArrayInput<MYSQL_TYPE_BLOB>>( \"NAME\", BUFF_SIZE)",
              ...
              "std::make_unique<TypeCharArrayOutput<MYSQL_TYPE_LONG_BLOB>>( \"NAME\", BUFF_SIZE)" } },
          { "tinyint",
            { "std::make_unique<InputImpl<signed char, MYSQL_TYPE_TINY>>(\"NAME\")",
              "std::make_unique<InputImpl<unsigned char, MYSQL_TYPE_TINY>>(\"NAME\")",
          ...
          { "smallint",
            { "std::make_unique<InputImpl<short, MYSQL_TYPE_SHORT>>(\"NAME\")",
              "std::make_unique<InputImpl<unsigned short, MYSQL_TYPE_SHORT>>(\"NAME\")",
          ...
          { "mediumint",
            { "std::make_unique<InputImpl<int, MYSQL_TYPE_LONG>>(\"NAME\")",
              "std::make_unique<InputImpl<unsigned int, MYSQL_TYPE_LONG>>(\"NAME\")",
          ...
          { "bigint",
            { "std::make_unique<InputImpl<long long, MYSQL_TYPE_LONGLONG>>(\"NAME\")",
              "std::make_unique<InputImpl<unsigned long long, MYSQL_TYPE_LONGLONG>>(\"NAME\")",
          ...
          { "float",
            { "std::make_unique<InputImpl<float, MYSQL_TYPE_FLOAT>>(\"NAME\")",
              "std::make_unique<InputImpl<float, MYSQL_TYPE_FLOAT>>(\"NAME\")",
              "std::make_unique<TypeOutputImpl<float, MYSQL_TYPE_FLOAT>>(\"NAME\")",
              "std::make_unique<TypeOutputImpl<float, MYSQL_TYPE_FLOAT>>(\"NAME\")" } },
          { "double",
            { "std::make_unique<InputImpl<double, MYSQL_TYPE_DOUBLE>>(\"NAME\")",
              "std::make_unique<InputImpl<double, MYSQL_TYPE_DOUBLE>>(\"NAME\")",
